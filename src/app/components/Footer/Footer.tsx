...
function Footer() {
    ...
    return (
        <div className='p-5 body-footer flex justify-center items-center'>
            <div className=" flex justify-center items-center  col-span-2 rounded-lg bg-black bg-opacity-70 gap-3 sm:ml-16 shadow-2xl grid lg:grid-cols-3 sm:flex-col md:flex-col xs:flex-col">
                {/* Left Column */}
                ...
                {/* Right Column */}
                <div className="col-span-2 flex flex-col lg:flex-row sm:flex-row xs:flex-col md:flex-col justify-between p-3">
                    <div className='lg:flex-col sm:flex-row xs:flex-row text-wrap'>
                        <div>
                            <div className='mt-10 font-montserrat lg:text-lg sm:text-sm text-white text-justify'>
                                <p className='m-2 text-justify'>Technology Business Incubator Foundation</p>
                        ...
                        <div className='grid gap-8'>
                            ...
                            <div className='text-center'>
                                <ul>
                                    ...
                                    <li className="text-white font-montserrat font-bold text-sm hover:text-orange-400 p-2 hover-underline-animation">
                                        <Link href="/about" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>About</Link>
                                    </li>
                                    <li className="text-white font-montserrat font-bold text-sm hover:text-orange-400 p-2 hover-underline-animation">
                                        <Link href="/team" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Team</Link>
                                    </li>
                                    <li className="text-white font-montserrat font-bold text-sm hover:text-orange-400 p-2 hover-underline-animation">
                                        <Link href="/facilities" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Support</Link>
                                    </li>
                                    <li className="text-white font-montserrat font-bold text-sm hover:text-orange-400 p-2 hover-underline-animation">
                                        <Link href="/career" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Career</Link>
                                    </li>
                                    <li className="text-white font-montserrat font-bold text-sm hover:text-orange-400 p-2 hover-underline-animation">
                                        <Link href="/contact-us" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>Contact Us</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
