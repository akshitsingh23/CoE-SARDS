...
import img0 from '../carousel/1.jpg';
import img1 from '../carousel/2.jpg';
import img2 from '../carousel/3.jpeg';
                    ...
                    <div key={program.id} className="program-item bg-gradient-to-tr from-blue-400 to-green-500 hover:bg-gradient-to-tr hover:from-red-800 hover:to-sky-400 hover:text-orange-200 font-Montserrat" data-wow-delay="0.2s" data-wow-duration="0.5s">
                        ...
                        <div className="program-figure">
                            <a href={program.link} className='flex justify-center items-center'>
                                <Image src={program.imageUrl} alt={program.title} className='h-40 w-80 object-cover p-1 rounded-2xl' />
                            </a>
                        </div>
